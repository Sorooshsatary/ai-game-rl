...
یک بستر تعاملی، آموزشی و مقایسه‌ای مبتنی بر **یادگیری تقویتی** و **عامل‌های قانون‌محور** که به گونه‌ای مهندسی شده تا کودکان، دانش‌آموزان و علاقه‌مندان بتوانند مفهوم هوش مصنوعی، محدودیت قوانین صلب برنامه‌نویسی و قدرت تصمیم‌گیری مبتنی بر تجربه و پاداش را به صورت ملموس، عملی و رو‌در‌رو بیاموزند.
...
graph TD
    subgraph Part1 ["بخش ۱: استراتژی شرطی من (قانون‌محور)"]
        ...
        B --> C["نمایش شکست قوانین صلب در شرایط پیش‌بینی‌نشده<br>(گیر افتادن یا حرکت تصادفی به دلیل نبود شرط)"]
    end
...
| `POST` | `/api/comparison/dual` | مسابقه همزمان استراتژی صلب با هوش مصنوعی | عمومی |
