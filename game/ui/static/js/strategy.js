...
const StrategyUI = {
  ...
  conditions: [
    ...
    { id: "exit_dist_le", name: "فاصله تا مسیر فرار کمتر یا مساوی", hasDistance: true, defaultDist: 3 },
    { id: "has_diamond", name: "کلید گنج در کوله‌پشتی داری", hasDistance: false },
    { id: "one_life", name: "فقط ۱ جان باقی مانده (خطر دستگیری)", hasDistance: false },
